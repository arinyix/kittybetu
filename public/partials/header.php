...
<header class="topbar">
  <div class="container">
    ...
    <nav class="nav">
      <a href="<?= e(APP_URL) ?>/create_match.php">Criar partida</a>
      <a href="<?= e(APP_URL) ?>/settle_event.php">Liquidar</a>
      <a href="<?= e(APP_URL) ?>/dashboard.php">Dashboard</a>
      <a href="<?= e(APP_URL) ?>/bets.php">Apostas</a>
      <a href="<?= e(APP_URL) ?>/my_bets.php">Minhas apostas</a>
